...
echo $nome." ".$descricao." ".$responsavel." ".$carga." ".$data." ".$local." ".$inicio." ".$termino;

$palestra = new Palestra($conexao);
$palestra->setNome($nome)->setDescricao($descricao)->setResponsavel($responsavel)->setCarga($carga)->setData($data)->setLocal($local)->setInicio($inicio)->setTermino($termino)->setStatus("Enc");
